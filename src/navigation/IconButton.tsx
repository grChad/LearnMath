...
export const IconBasic = ({ size, color, focused, bgSelect }: Props) => {
	return (
		<Svg
			width={size + 20}
			height={size}
			viewBox="0 0 384 512"
			style={{ backgroundColor: focused ? bgSelect : 'transparent', borderRadius: 15 }}
		>
			<Path
...
export const IconEquation = ({ size, color, focused, bgSelect }: Props) => {
	return (
		<Svg
			width={size + 20}
			height={size}
...
export const IconFunction = ({ size, color, focused, bgSelect }: Props) => {
	return (
		<Svg
			width={size + 20}
			height={size}
...
export const IconSetting = ({ size, color, focused, bgSelect }: Props) => {
	const normalPath =
